...
module.exports = (app: Application) => {
    ...
    const FolderImage = app.model.define('folder_name_img', {
        id: {
        ...
        src: { type: DataTypes.STRING(50), allowNull: false, unique: true, comment: '链接' },
        folderid: {
            type: DataTypes.INTEGER,
            references: {
                model: app.model.FolderName,
                key: 'id',
            },
        },
        created_time: {
        ...
        tableName: 'folder_name_img', // 自定义的表名，也可以不写，直接用define后面的也可以
